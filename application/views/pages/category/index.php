						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?= base_url("category/edit/$row->id") ?>" class="btn btn-sm btn-outline-dark rounded-3">
										<i class="bi bi-pencil-square"></i>
									</a>
									<button class="btn btn-sm btn-outline-danger rounded-3" type="submit" onclick="return confirm('Apakah yakin ingin menghapus?')">
